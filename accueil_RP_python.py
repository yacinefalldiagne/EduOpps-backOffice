...
from PySide6.QtWidgets import , QWidget,QMainWindow, QPushButton, QApplication,QTableWidget,QTableWidgetItem

class MySideBar(QMainWindow,Ui_Form_RP):
    def __init__(self):
        super().__init__()
        self.setupUi(self)
    ...
    def search_cahier(self):
        ...
        matiere = self.edit_matiere_cahier.text()
    ...
    def search_avis(self):
        classe = self.edit_classe_avis.text()
